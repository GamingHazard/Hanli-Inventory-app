          ...
          <View style={styles.listContainer}>
            ...
            {usedStockList.map((stock) => (
              <View key={stock.id} style={styles.listItem}>
                <View style={{ flex: 1 }}>
                  <Text style={styles.itemText}>Category: {stock.category}</Text>
                  <Text style={styles.itemText}>Item: {stock.item}</Text>
                  <Text style={styles.itemText}>Description: {stock.description}</Text>
                  <Text style={styles.itemText}>
                    Quantity: {stock.quantity} {stock.scale || ''}
                  </Text>
                </View>
                <TouchableOpacity onPress={() => handleDeleteItem(stock.id)} style={styles.deleteButton}>
